    ...
    stages {
        ...
        stage('Deploy') {
            ...
            steps {
                    ...
                    deploy adapters: [tomcat9(credentialsId: 'tomcat', path: '/home/fs-shubhranshu/Tomcat/apache-tomcat-9.0.78/webapps', url: 'http://localhost:8081')], contextPath: '/', war: '**/target/*.war'
