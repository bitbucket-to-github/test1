...
pipeline {
    ...
    stages {
        ...
        stage('Deploy') {
            ...
            steps {
                    deploy adapters: [tomcat9(credentialsId: 'tomcat', path: '', url: 'https://localhost:8081//home/fs-shubhranshu/Tomcat/apache-tomcat-9.0.78/webapps/')], contextPath: null, war: '**/*.war'
